...
describe("findAll", function () {
  ...
  test("works: by name filter case-insensitive", async function () {
  ...
  test("works: by minEmployees filter", async function () {
  ...
  test("works: by maxEmployees filter", async function () {
  ...
  test("works: by minEmployees and maxEmployees filter", async function () {
    let companies = await Company.findAll({
      minEmployees: 2,
      maxEmployees: 2,
    });
